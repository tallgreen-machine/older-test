...
interface CartSidebarProps {
    ...
    brand: 'fairwinds' | 'sunshine-pf';
}

export const CartSidebar: React.FC<CartSidebarProps> = ({ isVMI, cartItems, cartSubtotal, cartTotalItems, handleOrderSubmit, activeTab, onTabChange, orderHistory, onReorder, brand }) => {
